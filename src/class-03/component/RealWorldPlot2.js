...
export default class Example extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      data: addData(realWorldData, 0.02, 0.01, 0.08, 0.009),
    }
  }
      ...
      <div className="highlight-bar-charts small" style={{ userSelect: 'none' }}>
        <div className="normal">
          ...
          >
            ...
            />
            <Line yAxisId="1" type="monotone" dataKey="talk" stroke="#fcf8e3" dot={<div/>} strokeWidth="3px" isAnimationActive={false} />
            <Line yAxisId="1" type="monotone" strokeDasharray="3 3" dataKey="laplace2" stroke="#00BFFF" dot={<div/>} strokeWidth="3px" isAnimationActive={false} />
