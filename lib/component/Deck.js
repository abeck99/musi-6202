...
import gaTechWhite from '../../src/content/imgs/global/CenterForMusicTechLogo-White.png';
...
require("script!reveal.js/dist/reveal.js")
require("script!reveal.js/dist/reveal.js")
*/
...
export default class Deck extends Component {
  ...
  componentDidMount() {
    ...
    console.log("Here are the passed in options:");
    console.log(options);
  ...
  renderSlides(slides) {
    return slides.map((Slide, key) => {
      if (typeof Slide === "string") {
        return (
          <MarkdownSection key={key} markdown={Slide}/>
        );
        ...
        return (
          <Section key={key} dangerouslySetInnerHTML={Slide}>
          </Section>
        )
      } else {
    ...
    return (
      <div className="reveal">
        <div className="slides">
          ...
          {/*<div className="right top-right-logo"><img src={gaTechWhite}/></div>*/}
        </div>
      </div>
    );
  }
